<?php
// Обновления качать здесь: http://www.maxmind.com/download/geoip/database/GeoLiteCountry/GeoIP.dat.gz
...
function ip_img_style($ip = FALSE){
  ...
  return "float:left;margin-top:2px;width: {$w}px; height: {$w}px; background: url(/ip/{$path}) no-repeat scroll 0px -" . (array_search($name, $rel) * $w) . "px transparent;";  
}
